...
/**
 * Provides an interface for administrators to manage hospital staff, appointments,
 * medication inventory, and replenishment requests.
 */
public class AdministratorUI {
    ...
    /**
     * Constructs an AdministratorUI instance.
     *
     * @param scanner Scanner for user input
     * @param authController Controller for authentication actions
     * @param appointmentController Controller for appointment management
     */
     ...
     *
     * @param admin The administrator whose password is being changed
     */
    ...
    /**
     * Displays all hospital staff, grouped by their roles (Doctors, Pharmacists, Administrators).
     *
     * @param admin The administrator accessing the staff list
     */
     ...
     *
     * @param admin The administrator adding the new staff member
     */
     ...
     *
     * @param admin The administrator updating the staff details
     */
     ...
     *
     * @param admin The administrator removing the staff member
     */
    ...
    /**
     * Provides options to view, add, update, or remove hospital staff members.
     *
     * @param admin The administrator managing hospital staff
     */
    ...
    /**
     * Provides options to view, update stock levels, update alert levels,
     * or view inventory actions for the medication inventory.
     *
     * @param admin The administrator managing the inventory
     */
     ...
     *
     * @param admin The administrator updating the stock level
     */
     ...
     *
     * @param admin The administrator updating the alert level
     */
    ...
    /**
     * Displays the history of inventory actions.
     *
     * @param admin The administrator viewing the inventory actions
     */
    ...
    /**
     * Allows the administrator to approve or reject pending replenishment requests.
     *
     * @param admin The administrator managing the replenishment requests
     */
    ...
    /**
     * Displays the main menu for the administrator and handles navigation.
     *
     * @param admin The administrator accessing the UI
     */
    ...
    /**
     * Provides options for viewing appointments by different criteria such as date,
     * doctor, and status.
     *
     * @param admin The administrator viewing appointment details
     */
