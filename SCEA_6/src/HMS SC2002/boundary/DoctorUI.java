...
/**
 * The DoctorUI class provides an interface for doctors to manage their schedules,
 * patient records, and appointment requests.
 */
public class DoctorUI {
    ...
    /**
     * Constructs a new DoctorUI instance.
     *
     * @param scanner               Scanner for input.
     * @param authController        Authentication controller for managing passwords.
     * @param appointmentController Appointment controller for managing appointments.
     * @param medicalRecordController Medical record controller for accessing and updating medical records.
     * @param availabilityController Doctor availability controller for managing availability.
     */
    ...
    /**
     * Displays the main menu for the doctor, allowing them to select various options.
     *
    ...
    /**
     * Displays the menu options for the doctor.
     */
    ...
    /**
     * Allows the doctor to update a patient's medical record.
     *
     * @param doctor The currently logged-in doctor.
     */
    ...
    /**
     * Allows the doctor to view their personal schedule on a specific date.
     *
     * @param doctor The currently logged-in doctor.
     */
    ...
    /**
     * Allows the doctor to handle pending appointment requests by accepting or declining them.
     *
     * @param doctor The currently logged-in doctor.
     */
    ...
    /**
     * Allows the doctor to view their upcoming confirmed appointments.
     *
     * @param doctor The currently logged-in doctor.
     */
